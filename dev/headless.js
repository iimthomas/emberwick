...
const EXPORTS = ['CARD_DEFS', 'ROGUE_DEFS', 'DRAGONS', 'REGIONS', 'ROADS', 'MAGE', 'ROGUE',
                 ...
                 'SETOUT', 'SETOUT_BUCKETS', 'CONTRACTS', 'ARMOUR_POWER', 'ARMOUR_UP_COST', 'ARMOUR_UP_MAX', 'PATCH_NOTES', 'CLASS_KEY', 'UNLOCKS', 'UNLOCK_AT', 'LEVEL_CAP', 'XP_AWARD', 'XP_KEY', 'TUTORIAL', 'CLASSES', 'ARMOUR_SLOTS'];
