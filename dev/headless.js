...
const EXPORTS = ['STAGE_FLOORS', 'ARCH_MARK', 'STATUSES', 'AFFINITY', 'CARD_DEFS', 'ROGUE_DEFS', 'DRAGONS', 'REGIONS', 'ROADS', 'MAGE', 'ROGUE',
...
const TUNABLES = ['ATTUNE_BONUS', 'LOOSE_CUT', 'PAID_STEP', 'BANK_MULT', 'FOE_ATK_MULT', 'MOMENTUM_CAP', 'MOMENTUM_STEP', 'MOMENTUM_BREAK', 'MOMENTUM_VALUE', 'MOMENTUM_FULL', 'SPLIT_ADDS_PER_HIT', 'WAKE_PER_HIT', 'TIME_PENALTY_MULT', 'ELITE_HP', 'ELITE_ATK', 'ELITE_COIN',
                  'COIN_MULT', 'DRAGON_HP_ADD', 'EFFECT_WEIGHT', 'ARMOUR_SLOTS_OPEN', 'RELENTLESS_STEP', 'JOURNEY_MP_MULT', 'FORK_ENABLED', 'WHEEL_PER_ENCOUNTER',
